...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_notices, R.id.nav_homework, R.id.nav_marks, R.id.nav_marks_teacher, R.id.nav_homework_teacher,
                R.id.nav_messages_teacher, R.id.nav_messages_teacher, R.id.nav_drive, R.id.nav_drive_teacher, R.id.nav_editAddress)
